...
const AddFarmInfo = () => {
  ...
  const submitFarmInfo = async (e) => {
    ...
    const response1 = await addFarmInfomation(
      farmname,
      ownername,
      numberOflabor,
      totalarea,
    ...
    const response2 = await addFarmarea(
      latcoord,
      lngcoord,
      areacoord,
      farmname,
    ...
    <>
      ...
      <div className="w-full">
        <div className="mx-auto max-w-max">
          ...
          <form
            onSubmit={submitFarmInfo}
            className=" bg-slate-50 rounded-md shadow-xl p-4 my-6 border-2"
          >
            <div className="flex flex-row gap-x-28 justify-around">
              <div>
                <Map
                  setLatcoord={setLatcoord}
                  setLngcoord={setLngcoord}
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <FormControl isRequired>
                  <FormLabel htmlFor="number-of-labor">
                    Number of labor
                  </FormLabel>
                  <Input
                    value={numberOflabor}
                    onChange={(e) => setNumberOflabor(e.target.value)}
                    id="number-of-labor"
                    placeholder="Number"
                  />
                </FormControl>
                ...
                <FormControl isRequired>
                  <FormLabel htmlFor="number-of-plant">
                    Number of plant
                  </FormLabel>
                  <Input
                    value={numberOfplant}
                    onChange={(e) => setNumberOfplant(e.target.value)}
                    id="number-of-plant"
                    placeholder="Number"
                  />
                </FormControl>
                ...
                <FormControl isRequired>
                  <FormLabel htmlFor="water-source-rain">
                    The main water source for cultivation[Rainwater]
                  </FormLabel>
                  <Input
                    value={waterSourceRain}
                    onChange={(e) => setWaterSourceRain(e.target.value)}
                    id="water-source-rain"
                    placeholder="none"
                  />
                </FormControl>
                <FormControl isRequired>
                  <FormLabel htmlFor="water-source-irrigation">
                    The main water source for cultivation[Irrigation]{" "}
                  </FormLabel>
                  <Input
                    value={waterSourceIrri}
                    onChange={(e) => setWaterSourceIrri(e.target.value)}
                    id="water-source-irrigation"
                    placeholder="none"
                  />
                </FormControl>
              </div>
            </div>
            <div className="max-w-fit mx-auto mt-3">
              <Button className="" type="submit" colorScheme="blue">
