...
const EditFarmInfo = () => {
  ...
  const { getFarmInfomation, uid, isLoggedIn, editFarmInformation } =
  ...
  const editFarm = async (e) => {
    ...
    const response = await editFarmInformation(
      farmname,
      ownername,
      numberOflabor,
      totalarea,
    ...
    <>
      ...
      <div className="w-full">
        <div className="mx-auto max-w-md">
          ...
          <form
            onSubmit={editFarm}
            className="flex flex-col gap-y-3 bg-slate-50 rounded-md shadow-xl p-4 my-6 border-2"
          >
