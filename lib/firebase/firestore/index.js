...
export default class Firestore {
  ...
  getFarmcoordIdRef = (id) => doc(this.db, this.AreaCollection, id);
  ...
  async getActivity() {
    try {
      ...
      return act.docs.map((doc) => ({ ...doc.data(), id: doc.id }));
    } catch (error) {
      throw error;
    }
  }
  ...
  async deleteFarmarea(id) {
    try {
      const farmRef = this.getFarmcoordIdRef(id);
