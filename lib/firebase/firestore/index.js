import { getFirestore, doc, setDoc, getDoc, getDocs, addDoc, where, collection, serverTimestamp, updateDoc } from "firebase/firestore"
...
export default class Firestore {
    ...
    getEditfarmRef = (id) => doc(this.db, this.farmCollection, id)
    ...
    async editFarm(id, data) {
        try {
            const farmRef = this.getEditfarmRef(id)
